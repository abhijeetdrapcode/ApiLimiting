...
router.get('/', createToken, authentication, localization, getFirstOptimizePage);
router.get(
...
router.get('/:pageName', createToken, authentication, localization, getFirstOptimizePage);
router.get(
...
router.get(
  '/:pageName/:pageId/:collectionName',
  createToken,
  authentication,
  localization,
  getFirstOptimizePage,
